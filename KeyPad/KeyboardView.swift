...
struct SettingsView: View {
    ...
    var layoutTab: some View {
        Form {
            Section(header: Text("Dimensions"), footer: Text("Keyboard width auto-adjusts the overall panel size.")) {
                ...
                settingRow("Corner Radius", icon: "corner.rounded", value: settings.keyCornerRadius, range: 0...12, step: 1, tip: "Roundness of key corners") {
    ...
    var behaviorTab: some View {
        Form {
            ...
            Section(header: Text("Startup"), footer: Text("Which panel shows when KeyPad launches.")) {
                HStack {
                ...
                .help("Automatically start KeyPad when you log in")
            }
